...
from backend.app.component_center.service.card_list_page import (
    CardListPageService,
    CardListPageServiceError,
)
...
def init_card_list_page_api(bp, db, models):
    ...
    @bp.route('/api/admin/component-center/card-list-page', methods=['GET', 'POST'])
    @login_required
    ...
    @bp.route('/api/admin/component-center/card-list-page/<int:item_id>', methods=['GET', 'PUT', 'DELETE'])
    @login_required
    def manage_card_list_page_detail(item_id):
